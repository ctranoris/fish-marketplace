    ...
    public String push() {
        ...
        try {
            ...
            if (pendingSystemStatus == null){
            	System.out.println("pendingSystemStatus == null...trying by default the first one if exists");
            	SortedSet sortedSet = new SortedSet();
            	sortedSet = SystemDB.getUserSystemSet(sortedSet, userId);
            	
            	List<HostSystem> hostSystemList = sortedSet.getItemList();    	
            	
            	pendingSystemStatus = hostSystemList.get(0);
            }
            ...
            if (pendingSystemStatus != null) {
                ...
                System.out.println("push upload to system from :"+UPLOAD_PATH + "/" + uploadFileName +" to "+pushDir + "/" + uploadFileName);
            	...
            	System.out.println("push upload failed...");
            	
            }

            //if push has finished to all servers then delete uploaded file
            if (pendingSystemStatus == null) {
            	System.out.println("push has finished to all servers then delete uploaded file");
