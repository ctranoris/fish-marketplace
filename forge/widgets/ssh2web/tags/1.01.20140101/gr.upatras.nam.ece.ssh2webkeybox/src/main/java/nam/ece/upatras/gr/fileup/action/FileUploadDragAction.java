...
public class FileUploadDragAction extends ActionSupport  implements ServletRequestAware, ServletResponseAware {
	...
	@Action(value = "/fileuploaddrag",
            results = {
                    @Result(name = "success", location = "/fileUpload/uploadFilesDrag.jsp")
            }
    )
	...
	@Action(value = "/fileresultdrag",
            ...
            results = {
                    @Result(name = "success", location = "/fileUpload/uploadFilesDrag.jsp"),
                    @Result(name = "error", location = "/fileUpload/uploadFilesDrag.jsp"),
                    @Result(name = "input", location = "/fileUpload/uploadFilesDrag.jsp")
            }
    )
