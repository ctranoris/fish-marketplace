...
$(function(){
  ...
  var library = {
    image: [
      ...
      {"src":"meemoo:image/costas","info":{"title":"costas","author":"meemoo","description":"draw costas to a canvas"}}
    ],
    effects: [
    ...
    "costas": [      
      {"src":"meemoo:ui/button","info":{"title":"button","author":"meemoo","description":"a button sends a bang, and you can attach a keyboard key"}},
      {"src":"meemoo:ui/checkbox","info":{"title":"checkbox","author":"meemoo","description":"a checkbox to send boolean on/off"}},
	  {"src":"http://localhost/test_meemoo_costas.html","info":{"title":"costas_test","author":"nam ece.upatras","description":"costas_test_1"}},
	  {"src":"http://localhost/widget_meemoo_googlesearch.html","info":{"title":"Widget_googlesearch","author":"nam ece.upatras","description":"costas_test_1"}},
      {"src":"https://150.140.184.215:8443/login.action","info":{"title":"terminal","author":"nam ece.upatras","description":"connect to a terminal"}}	  
    ]
  };
